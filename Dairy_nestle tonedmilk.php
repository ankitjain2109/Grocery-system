...
{
	document.getElementById("txtHint3").innerHTML="Nestle Toned milk is milk acquired by the addition of water and skim milk powder to the entire milk. In practice, entire milk from buffalo is blended with reconstituted spray dried skim milk for the production of toned milk. It ensures that there is whole destruction of bacteria and spillage enzymes."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="(per 100 g) Energy: 57 kcal Protein: 2.8 g Carbohydrate: 4.9 g Sugar: 0.0 g Fat: 3.0 g Calcium: 84.0 mg"
	}
</script>
...
<form method="post" action="Dairy_nestle tonedmilk.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="427" height="275"><br>
      <img src="Pj/dairy products/nestle-toned-milk-a.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="361" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Nestle Toned Milk  </i>
	<br><i>1 lt</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 75<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Nestle TonedMilk">
	<input type="hidden" name="product_price" value="75">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/nestle-toned-milk-a.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="tonm" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<button value="Facts" border="1px" type="button" onClick="showUseringredients()" style="background-color:#FFFFFF; width:70px; height:40px">Facts</button>
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
	 Nestle Toned milk is milk acquired by the addition of water and skim milk powder to the entire milk. In practice, entire milk from buffalo is blended with reconstituted spray dried skim milk for the production of toned milk. It ensures that there is whole destruction of bacteria and spillage enzymes.
		  	</td>
		</tr>
		</table>
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
   <script type="text/javascript">
        ...
        var disqus_shortname = 'dairynestletonedmilk'; // required: replace example with your forum shortname
