...
<table width="74%" height="300" align="center" style="background-color:#E4E3E6">
  ...
  <tr>
    <th> <table width="100%" height="100px" align="center">
...
$res= $a[$aa].$b[$bb].$c[$cc];
?>
          <?php ?><input type="image" align="left" value="<?php echo $res;  ?>" style="color:<?php echo $col[$color];?>; font-family:<?php  echo $style[$font]; ?>; font-size:36px; border:3px solid #CCCCCC;" width="245" height="45" align="middle"><?php ?>
        </p>
      <br>
      <br>
      <br>
        <p align="left">
          <input type="text" name="code" style="width:245px; height:30px;"/>
        </p>
      <p align="left"><br>
            <input type="checkbox" name="checkbox" hspace="10px" align="left"/>
        &nbsp;&nbsp; I AGREE THE TERMS AND CONDITION </p>
      <p align="left">
        <input type="button" name="register" value="Finish" hspace="55px" style="width:125px; height:35px;"/>
      </p></th>
  </tr>
</table>
</body>
