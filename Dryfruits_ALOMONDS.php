...
{
	document.getElementById("txtHint3").innerHTML="	Mamra Almonds are wealthy source of Minerals, Proteins & Vitamins. The Almond Mamra is rarer still, tastier and contains higher nutritional content compared to other almonds. It is an excellent source of calcium, magnesium, phosphorus, potassium & fiber.Almonds are used to make oil that is used as a moisturizer as well as a culinary ingredient. They can be used as garnish and is a common ingredient in desserts. Most popularly used to make badam milk."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="It prevents coronary artery disease & strokes by favoring healthy blood lipid profile and it prevents skin disorder, anemia & respiratory diseases. It improves the movement of food through the colon, thereby preventing colon cancer and protection against diabetes. It is good for brain and heart."
	}
</script>
...
<form method="post" action="Dryfruits_ALOMONDS.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226px" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    <td height="275"><br><img src="Pj/dry fruits/royal-almond-mamra.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Almonds  </i>
	<br><i>200gm Tray</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 639<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Royal Almond mamra">
	<input type="hidden" name="product_price" value="639">
	<input type="hidden" name="product_imgname" value="Pj/dry fruits/royal-almond-mamra.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="almo" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Mamra Almonds are wealthy source of Minerals, Proteins & Vitamins. The Almond Mamra is rarer still, tastier and contains higher nutritional content compared to other almonds. It is an excellent source of calcium, magnesium, phosphorus, potassium & fiber.
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'dryfruitsalomonds'; // required: replace example with your forum shortname
