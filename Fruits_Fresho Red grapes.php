...
<form method="post" action="Fruits_Fresho Red grapes.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/grapes-red-globe.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho  Red grapes</i>
	<br><i>250 gm</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 117<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Fresh Red Grapes">
	<input type="hidden" name="product_price" value="117">
	<input type="hidden" name="product_imgname" value="Pj/fruits/grapes-red-globe.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="grap" />';
 ...
 Red Globe grapes are uniquely large and round. They have large seeds, a crunchy skin and fleshy pulp and are pinkish red in color. These are mildly sweet and tasty. They are not as tangy as flame seedless or as sweet as Thompson seedless.
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshoredgrapes'; // required: replace example with your forum shortname
