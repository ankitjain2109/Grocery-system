...
{
	document.getElementById("txtHint3").innerHTML="Fresh Table eggs are hygienically processed and securely filled for keeping these free from any contamination and impurity. It has high dietary content, protein, smell and rich taste. These are one of nature's most wholesome and cost-effective foods. You can bake enjoyable cakes, cookies, scones etc. with eggs; try your hand over at family pasta as well. It twisted boiled, sunny-side up,deviled or evens the Indian method curry eggs can be finished in so many unique tasty ways.Besides its direct use, eggs are used as main ingredients in so many other dishes. You can bake yummy cakes, cookies, scones etc. with eggs; try your hand at homemade pasta as well. There is so much you can do with just one egg!Buy online and save yourself the exhaustive trips to grocery stores. Just a few clicks and it will be delivered right to your doorstep."
	}
...
<form method="post" action="Eggs_ Fresh table eggs.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br>
      <img src="Pj/dairy products/fresh-table-eggs-regular.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresh Eggs  </i>
	<br><i>6 pcs</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 35<form method="post" action="cart_update.php">
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">&nbsp;&nbsp;<button style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;">ADD</button>	</td >
  <tr><input type="hidden" name="product_name" value="Fresh Table Eggs">
	<input type="hidden" name="product_price" value="35">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/fresh-table-eggs-regular.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="fteggs" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">Fresh Table eggs are hygienically processed and securely filled for keeping these free from any contamination and impurity. It has high dietary content, protein, smell and rich taste. These are one of nature's most wholesome and cost-effective foods. You can bake enjoyable cakes, cookies, scones etc. with eggs; try your hand over at family pasta as well. It twisted boiled, sunny-side up, deviled or evens the Indian method curry eggs can be finished in so many unique tasty ways.Besides its direct use, eggs are used as main ingredients in so many other dishes. You can bake yummy cakes, cookies, scones etc. with eggs; try your hand at homemade pasta as well. There is so much you can do with just one egg!Buy online and save yourself the exhaustive trips to grocery stores. Just a few clicks and it will be delivered right to your doorstep.		  	</td>
		</tr>
		</table>	</td>
    </tr>
  </table>
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
   <script type="text/javascript">
        ...
        var disqus_shortname = 'eggsfreshtableeggs'; // required: replace example with your forum shortname
