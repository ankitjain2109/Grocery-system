...
$sql=mysql_query("select * from new_arrival where product_name='fresho-tomato-hybrid-grade-a'");
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/new arrivals/fresho-tomato-hybrid-grade-a.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
    ...
    echo '<input type="hidden" name="product_code" value="tomh" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		Tomato Hybrid is truly healthier than others. It is packed with the 50% more of the beneficial antioxidant lycopene which provides the fruit’s red color. These are rich in vitamins, moisture and phytonutrients and minerals. They are an outstanding supply of vitamins C, K and B6, beta-carotene, biotin, potassium, niacin, calcium, iron, phosphorous, selenium and zinc, as well as of many organic acids such as citric and malic acids.
