...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
	...
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 95<?php ?>
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">&nbsp;&nbsp;<input type="button" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD">	
	</td >
  <tr>
  <tr >
