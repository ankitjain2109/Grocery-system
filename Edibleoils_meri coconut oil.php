...
{
	document.getElementById("txtHint3").innerHTML="Merit VCO Extra Virgin Coconut Oil is completed from fresh mature coconuts and is processed right at our processing plant at Patalganga industrial area. It is cold processed thus maintaining the light scent and flavor of new coconuts. It is rich in medium chain fatty acids, mainly Lauric Acid. Lauric acid is the same fatty acid found in mother's milk that gives protection to babies. Among the benefits of VCO (Virgin Coconut oil) are it helps weight-loss by increasing metabolism, improves the immune system, it has anti-bacterial and anti-viral properties and it has first-class moisturizing properties as well.If you have sensitive skin, athlete's foot, acne, eczema, psoriasis, sunburn, dandruff, dry skin, aging skin, corns or fungal infections, use on your skin or massage in this top quality organic cold pressed virgin coconut oil that can help you with your skin problems."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="It is an exceptionally healthful low calorie, high fiber food that offers significant protection against cardiovascular disease and cancer. It helps to lower the blood pressure and lower bad cholesterol and keep arteries clear. Vitamin B6 in potatoes contributes to cellular renewal, a healthy nervous system, and balanced mood."
	}
</script>
...
<form method="post" action="Edibleoils_meri coconut oil.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr >
  <br>
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp; Edible oils & Ghee  </font>  </tr>
  <tr>
  <tr >
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/edible oils & ghee/merit-vco-coconut-oil-extra-virgin.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Merit Vco Coconut Oil  </i>
	<br><i>500 ml Tray</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 355<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Coconut Oil Extra Virgin">
	<input type="hidden" name="product_price" value="355">
	<input type="hidden" name="product_imgname" value="Pj/edible oils & ghee/merit-vco-coconut-oil-extra-virgin.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="merit" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
			 Merit VCO Extra Virgin Coconut Oil is completed from fresh mature coconuts and is processed right at our processing plant at Patalganga industrial area. It is cold processed thus maintaining the light scent and flavor of new coconuts. It is rich in medium chain fatty acids, mainly Lauric Acid. Lauric acid is the same fatty acid found in mother's milk that gives protection to babies. Among the benefits of VCO (Virgin Coconut oil) are it helps weight-loss by increasing metabolism, improves the immune system, it has anti-bacterial and anti-viral properties and it has first-class moisturizing properties as well.If you have sensitive skin, athlete's foot, acne, eczema, psoriasis, sunburn, dandruff, dry skin, aging skin, corns or fungal infections, use on your skin or massage in this top quality organic cold pressed virgin coconut oil that can help you with your skin problems.		  	</td>
		</tr>
		</table>	</td>
    </tr>
  </table>
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'edibleoilsmericoconutoil'; // required: replace example with your forum shortname
