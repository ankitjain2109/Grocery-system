...
function showUser(str) {
  ...
  xmlhttp.open("GET","getdryfruits.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
window.mm_menu_1004170146_0 = new Menu("root",277,23,"Arial, Helvetica, sans-serif",17,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",3,0,1000,-5,7,true,true,true,0,false,true);
  ...
  mm_menu_1004173024_0.addMenuItem(mm_menu_1004173024_0_2);
   ...
   mm_menu_1004173024_0.menuBorderBgColor='#CCCCCC';
    ...
    mm_menu_1005154101_0_4.addMenuItem("Cooking&nbsp;Paste","location='edible_oil_ghee_main.php'");
    mm_menu_1005154101_0_4.addMenuItem("Powdered&nbsp;Spices","location='edible_oil_ghee_main.php'");
    mm_menu_1005154101_0_4.addMenuItem("Whole&nbsp;Spices","location='edible_oil_ghee_main.php'");
  ...
  mm_menu_1005155710_0.addMenuItem("Eggs","location='eggs_main.php'");
   ...
   mm_menu_1005155710_0.menuBorderBgColor='#CCCCCC';
    ...
    mm_menu_1005160226_0_1.addMenuItem("Other&nbsp;Juices","location='orange_apple_main.php'");
...
<form method="post" action="dry_fruits_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
      ...
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link16" id="link7" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005155710_0,150,0,null,'link16')" onMouseOut="MM_startTimeout();">BREAD DIARY & EGGS<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; DRY FRUITS
