...
$sql=mysql_query("select * from offers where product_name='fresho-sweet-lime-large-grade'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Sweet Lime is a versatile fruit with a sugary and sour flavor. These are pale yellow colored, mildly sugary tasting, juicy fruits that is native to South Asia. This amazing fruit makes terrific nutritional value. It is low in calories; presently 43 calories per 100 grams. The peel can differ in thickness from thin to quire thick."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Sweet Lime is a coolant, and has antiseptic, anti-congestant, antiviral, anticancer & anti-inflammatory properties. It is also beneficial for cardiovascular health. It dissolves crystals that form in the arthritic joints. and prevents and treats scurvy."
	}
</script>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/offers/fresho-sweet-lime-large-grade.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
    ...
    echo '<input type="hidden" name="product_code" value="swta" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Sweet Lime is a versatile fruit with a sugary and sour flavor. These are pale yellow colored, mildly sugary tasting, juicy fruits that is native to South Asia. This amazing fruit makes terrific nutritional value. It is low in calories; presently 43 calories per 100 grams. The peel can differ in thickness from thin to quire thick.
	</td>
		</tr>
		</table>	</td>
    </tr>
...
<p style="width:50%">
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'freshosweetlime'; // required: replace example with your forum shortname
