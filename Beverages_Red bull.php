...
function showUserabout()
	{
	document.getElementById("txtHint3").innerHTML="Red Bull Energy Drink is a functional beverage providing various benefits. Red Bull’s effects are recognized throughout the world by a variety of people such as top athletes, busy professionals, college students and travelers on long journeys"
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Caffeine, Taurine, B-Vitamins, Sucrose, Glucose and Alpine Spring Water"
	}
</script>
...
<form method="post" action="Beverages_Red bull.php">
...
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    <td height="275"><br><img src="Pj/energy and drink/red-bull-energy-drink.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Red-Bull</i><br><i>355 ml</i> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 150<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Red Bull">
	<input type="hidden" name="product_price" value="150">
	<input type="hidden" name="product_imgname" value="Pj/energy and drink/red-bull-energy-drink.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="rdb" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Red-Bull</i>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Red Bull Energy Drink is a functional beverage providing various benefits. Red Bull’s effects are recognized throughout the world by a variety of people such as top athletes, busy professionals, college students and travelers on long journeys
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
    <script type="text/javascript">
        ...
        var disqus_shortname = 'redbulldailyneeds'; // required: replace example with your forum shortname
