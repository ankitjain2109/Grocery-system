...
<form method="post" action="Dairy_Amul Butter.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="376" height="275"><br>
      <img src="Pj/dairy products/amul-butter-pasteurized.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="412" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Amul Butter   </i>
	<br><i>500 gm</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 182<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Amul Pasteurized Butter">
	<input type="hidden" name="product_price" value="182">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/amul-butter-pasteurized.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="butteramul" />';
  ...
  <tr >
    <td height="673" colspan="4">
	 ...
	 Amul Masti spiced buttermilk is 100% natural and sucrose free without any colour or preservatives added. It is a low fat product with lower sodium salt content. It contains protein with almost 50% lower calories than soft drinks. And the spices and condiments added to the product just enhance its taste and flavour.
		  	</td>
		</tr>
		</table>
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'dairyamulbutter'; // required: replace example with your forum shortname
