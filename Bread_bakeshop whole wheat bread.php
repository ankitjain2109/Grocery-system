...
<form method="post" action="Bread_bakeshop whole wheat bread.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
      ...
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link18" id="link11" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005162054_0,216,-170,null,'link18')" onMouseOut="MM_startTimeout();">PERSONAL CARE<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/bakeshopbreadwholewheatslicedhighfibre.jpg" class="effectscale" width="221" height="225" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The Bake Shop Bread - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Whole Wheat Sliced</i>
	<br><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;400 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 40<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Bake Shop Bread - Whole Wheat Sliced ">
	<input type="hidden" name="product_price" value="40">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/bakeshopbreadwholewheatslicedhighfibre.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="slicbrd" />';
  ...
  <tr >
    <td height="673" colspan="4">
	 ...
	 A healthy brown bread made using whole wheat (atta) and wheat bran. This bread is high in fibre and will make your sandwiches more tasty and healthy.
		  	</td>
		</tr>
		</table>
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
    <script type="text/javascript">
        ...
        var disqus_shortname = 'breadbakeshopwholewheatbread'; // required: replace example with your forum shortname
