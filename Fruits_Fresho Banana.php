...
{
	document.getElementById("txtHint3").innerHTML="Yelakki bananas are tiny sized bananas around 3- 4 inches in length, contain a thinner skin and improved shelf life than Robusta bananas. Green fruits turn golden yellow on developing, and the flesh is white in color. They contain a good taste which is mainly sweet but with a slight sour touch. It also contains a fragrant aroma. Bananas are simple to digest."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="It has a natural antacid effect in the body and neutralizes over-acidity, reduces irritation by coating the lining of the stomach and soothes ulcers & heartburn. It contains the amino acid tryptophan which helps the body to produce serotonin - which has a calming effect on the brain and is known to make you relax. It contains B Vitamins & minerals that lessen the effects of nicotine withdrawal."
	}
</script>
...
<form method="post" action="Fruits_Fresho Banana.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/banana-robusta-semi-ripe-grade-a-super.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho Banana </i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 34<?php ?><form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Fresh Banana">
	<input type="hidden" name="product_price" value="34">
	<input type="hidden" name="product_imgname" value="Pj/fruits/banana-robusta-semi-ripe-grade-a-super.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="banana" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
			Yelakki bananas are tiny sized bananas around 3- 4 inches in length, contain a thinner skin and improved shelf life than Robusta bananas. Green fruits turn golden yellow on developing, and the flesh is white in color. They contain a good taste which is mainly sweet but with a slight sour touch. It also contains a fragrant aroma. Bananas are simple to digest.
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshobanana'; // required: replace example with your forum shortname
