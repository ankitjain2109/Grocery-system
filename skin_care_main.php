...
function showUser(str) {
  ...
  xmlhttp.open("GET","getskincare.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="skin_care_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >      <tr height="35px" bgcolor="#8fb242">
	  ...
	  <input type="radio" name="pack_size[]" value="5gm" onClick="showUser(this.value)">5gm-25gm<br>
	
	  <input type="radio" name="pack_size[]" value="others" onClick="showUser(this.value)">Others<br>
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; SKIN CARE &nbsp;&nbsp;&nbsp;
	<select id="box2" style="background-color: #CCCCCC;" size="1" name="view_by" onChange="showUser(this.value)" autofocus >
