...
$sql=mysql_query("select * from new_arrival where product_name='nescafe-coffee-classic'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Nescafe Classic Coffee comes from 100% pure, high quality coffee beans. Enjoy a rich, full-bodied cup of coffee. Perfect for camping and other holiday times."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="100% soluble coffee from coffee beans"
	}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/new arrivals/nescafe-coffee-classic.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr >
    <td height="673" colspan="4">
		...
		Nescafe Classic Coffee comes from 100% pure, high quality coffee beans. Enjoy a rich, full-bodied cup of coffee. Perfect for camping and other holiday times.
