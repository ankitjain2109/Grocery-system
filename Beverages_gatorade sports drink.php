...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Gatorade sports drink lemon Flavour is the best Flavour and also the first Flavour of Gatorade and has strong lemon and lime taste. It is exclusively made to restore the body energy."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Sucrose, salt, sodium citrate, citric acid mono potassium phosphate, dextrose natural lemon and lime Flavours with other natural Flavours, yellow."
	}
...
<form method="post" action="Beverages_gatorade sports drink.php">
...
<tr>
<th></th><th><a href="main.php"><img src="Pj/admin/logo.jpg" align="middle" class="image2" style="size:landscape; height: 125px; width:245px"/></a></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="text" name="search" class="image2" width="300px" height="200px" size="+60" placeholder="&nbsp;&nbsp;&nbsp;Search your needs" style="border-radius:8px; height:25px; width:500px";/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="submit" name="srchbutton" value="SEARCH" class="image2" style="height:25px; width:80px"/></th>&nbsp;&nbsp;&nbsp;<th style="background-color:#f5f4f4"><a href="view_cart.php" style="text-decoration:none">Your Basket Has <?php echo $_SESSION['count']; ?> Item<br> <img src="Pj/bskt.jpg" height="36px"/> </span>
</a></th>
</tr>
</table></form>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a style="text-decoration:none;" href="new_arrival.php">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
  ...
  <tr>
    <tr>
        <td height="275"><br>
            <img src="Pj/energy and drink/gatorade-sports-drink-lemon-flavor.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"> <br>
        </td>
        <td valign="top">&nbsp;<br>
            <br>
          &nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Gatorade Sports Drink- Lemon Flavor</i><br>
            <i>500 ml</i>
            <?php ?>
            </b> <br>
            <br>
          ...
          <form action="cart_update.php" method="post">
            <br>
          &nbsp;&nbsp; Qty&nbsp;
          <input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">
          &nbsp;&nbsp;
          <input type="submit" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" value="ADD">
        </td >
    <tr><input type="hidden" name="product_name" value="Gatorade Sports Drink Lemon Flavor">
	<input type="hidden" name="product_price" value="45">
	<input type="hidden" name="product_imgname" value="Pj/energy and drink/gatorade-sports-drink-lemon-flavor.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="gtd" />';
            echo '<input type="hidden" name="type" value="add" />';
			echo '<input type="hidden" name="return_url" value="'.$current_url.'" />';
	 ?>
    <tr >
        <td height="673" colspan="4"><br>
          &nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Gatorade Sports Drink- Lemon Flavor</i> <br>
            <br>
          <p>
            <button type="button" value="About" border="1px" onClick="showUserabout();" style="background-color:#FFFFFF; width:70px; height:40px">About</button>
		<button type="button" value="Ingredients" border="1px" onClick="showUseringredients();" style="background-color:#FFFFFF; width:70px; height:40px">Ingredients</button>
          <table align="center" border="1px" height="5%" width="98%" vspace="65px">
            <tr>
              <td style="font-size:18px; border:thin;" id="txtHint3" class="image2"> Gatorade sports drink lemon Flavour is the best Flavour and also the first Flavour of Gatorade and has strong lemon and lime taste. It is exclusively made to restore the body energy. </td>
            </tr>
          </table>
      </td>
    </tr>
...
<p style="width:50%">
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'gatoradesportsdrink'; // required: replace example with your forum shortname
