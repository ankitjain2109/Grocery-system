...
{
	document.getElementById("txtHint3").innerHTML="Britannia Processed Cheddar Cheese Slice is the Classic cheese, moon-shaped and with an international taste, which makes your breads/sandwiches etc. It contains a glass of cow’s milk known to be rich in calcium, protein and vitamins. It is made at hi-tech facilities under high-quality conditions, and from cow's milk, Britannia Cheese range is a very tasty and healthy food for the family. It provides a variety of easy, quick, tasty, healthy recipes for family, guests and kids' tiffins."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Cheese, Milk Soilds,Iodised salt, Emulsifier (E331, E 339), Acidifying Agent (E 330, E 260), Preservative (E 200), Colour (E 160(ii))."
	}
</script>
...
<form method="post" action="Dairy_Brittannia Cheese.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/dairy products/britannia-cheese-slice-processed-cheddar.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Britannia Cheese  </i>
	<br><i>200 gm</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 128<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Britannia Cheese Sliced">
	<input type="hidden" name="product_price" value="128">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/britannia-cheese-slice-processed-cheddar">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="chee" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<button value="Ingredients" border="1px" onClick="showUseringredients()" type="button" style="background-color:#FFFFFF; width:70px; height:40px">Ingredients</button>
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
	 Britannia Processed Cheddar Cheese Slice is the Classic cheese, moon-shaped and with an international taste, which makes your breads/sandwiches etc. It contains a glass of cow’s milk known to be rich in calcium, protein and vitamins. It is made at hi-tech facilities under high-quality conditions, and from cow's milk, Britannia Cheese range is a very tasty and healthy food for the family. It provides a variety of easy, quick, tasty, healthy recipes for family, guests and kids' tiffins.
		  	</td>
		</tr>
		</table>
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'dairybrittanniacheese'; // required: replace example with your forum shortname
