...
$sql=mysql_query("select * from new_arrival where product_name='pepsi-soft-drink-diet'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Diet Pepsi contains softly changed its sweetener. It is not caffeine free, so you require factoring its caffeine content into your daily drinking. Pepsi is ubiquitous on just about each social instance. Be it parties, hangouts with friends, or just an additional day at home, a day is never complete lacking the fizz of Pepsi.This Carbonated water contains an admixture of Aspartame (Methyl esler) and Acesulfame Potassium. Not recommended for children. No sugar added in the product. Not for Phenyketonurics."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Calories : 0 Calories from Fat : 0 Total Fat : 0.0g Sodium : 0mg Carbohydrates : 0.0g Protein : 0.0g."
	}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >      <tr height="30px" bgcolor="#8fb242">
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/new arrivals/pepsi-soft-drink-diet.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
	...
	<br>
	<br>
	<br>&nbsp;&nbsp;&nbsp;Market Price  <?php echo $res["price"];?>
	<br>
	
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">&nbsp;&nbsp;<input type="button" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD">	</td >
  <tr>
  <tr >
...
<p style="width:50%">
  ...
  <script type="text/javascript">
        ...
        var disqus_shortname = 'organaorganicdrinkrefreshingapple'; // required: replace example with your forum shortname
