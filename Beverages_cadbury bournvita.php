...
{
	document.getElementById("txtHint3").innerHTML="Cadbury Bournvita Shakti health drink combines the integrity of nourishment and lusciousness of chocolate to give the mothers and their children an ideal solution. Making that daily glass of milk appetizing, Cadbury Bournvita is a must keep in every family, particularly one with kids."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Malt Extract, Sugar, Cocoa Solids, Milk Solids, Carmel (E 150), Liquid Glucose, Emulsifiers (E 322, E 471), Vitamins, Minerals, Raising Agents (E 500), Salt, Ethyl Vanillin, Liquid Vanilla Flavour. Contains Artificial Flavor and Substances"
	}
</script>
...
function mmLoadMenus() {
  if (window.mm_menu_1004165716_0) return;
                window.mm_menu_1004165716_0_1 = new Menu("Timings",248,22,"Arial, Helvetica, sans-serif",16,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",3,0,1000,-5,7,true,true,true,0,false,true);
    ...
    window.mm_menu_1004165716_0_2 = new Menu("Login",248,22,"Arial, Helvetica, sans-serif",16,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",3,0,1000,-5,7,true,true,true,0,false,true);
    mm_menu_1004165716_0_2.addMenuItem("Register");
     mm_menu_1004165716_0_2.fontWeight="bold";
     mm_menu_1004165716_0_2.hideOnMouseOut=true;
     mm_menu_1004165716_0_2.bgColor='#FDFBFA';
     mm_menu_1004165716_0_2.menuBorder=1;
     mm_menu_1004165716_0_2.menuLiteBgColor='#FCFBF9';
     mm_menu_1004165716_0_2.menuBorderBgColor='#000000';
  window.mm_menu_1004165716_0 = new Menu("root",248,22,"Arial, Helvetica, sans-serif",16,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",3,0,1000,-5,7,true,true,true,0,false,true);
  mm_menu_1004165716_0.addMenuItem("Delivery&nbsp;Slots");
  mm_menu_1004165716_0.addMenuItem(mm_menu_1004165716_0_1);
  mm_menu_1004165716_0.addMenuItem(mm_menu_1004165716_0_2);
...
<form method="post" action="Beverages_cadbury bournvita.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
      ...
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1" name="link15" id="link4" style="font-size:11px;font-family:Arial, Helvetica, sans-serif;" onMouseOver="MM_showMenu(window.mm_menu_1004173024_0,210,-30,null,'link15')" onMouseOut="MM_startTimeout();">FRUITS & VEGETABLES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link3" id="link5" style="font-size:11px; font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005154101_0,210,5,null,'link3')" onMouseOut="MM_startTimeout();">GROCERY & STAPLES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link17" id="link7" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005155710_0,210,5,null,'link17')" onMouseOut="MM_startTimeout();">BREAD DIARY & EGGS<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link18" id="link9" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005160226_0,216,-60,null,'link18')" onMouseOut="MM_startTimeout();">BEVERAGES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
      ...
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link8" id="link11" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005162054_0,216,-170,null,'link8')" onMouseOut="MM_startTimeout();">PERSONAL CARE<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
  ...
  <tr >
  <br>
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp; BEVERAGES</font>	</tr>
  <tr>
  <tr >
  ...
  <tr>
    <td height="275"><br><img src="Pj/energy and drink/cadbury-bournvita-health-drink.jpg" class="effectscale"  width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Cadbury Bournvita</i><br><i>500 gm</i> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 200<form action="cart_update.php" method="post">
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">&nbsp;&nbsp;<input type="submit" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" value="ADD">	
	</td >
  <tr><input type="hidden" name="product_name" value="Cadbury Bournvita Health Drink">
	<input type="hidden" name="product_price" value="200">
	<input type="hidden" name="product_imgname" value="Pj/energy and drink/cadbury-bournvita-health-drink.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="cdb" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Cadbury Bournvita</i>
		
		<br><br>
		<p> <button type="button" value="About" border="1px" onClick="showUserabout();" style="background-color:#FFFFFF; width:70px; height:40px">About</button>
		<button type="button" value="Ingredients" border="1px" onClick="showUseringredients();" style="background-color:#FFFFFF; width:70px; height:40px">Ingredients</button>
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Cadbury Bournvita Shakti health drink combines the integrity of nourishment and lusciousness of chocolate to give the mothers and their children an ideal solution. Making that daily glass of milk appetizing, Cadbury Bournvita is a must keep in every family, particularly one with kids.
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
    <script type="text/javascript">
        ...
        var disqus_shortname = 'cadburybournvita'; // required: replace example with your forum shortname
