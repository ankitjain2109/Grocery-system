...
function showUser(str) {
  ...
  xmlhttp.open("GET","getdeo.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="deo_perfume_main.php.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226px" height="800px" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
	  ...
	  <input type="radio" name="price[]" value="between200and500" onClick="showUser(this.value)" >Rs200 and above
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; DEO & PERFUMES
