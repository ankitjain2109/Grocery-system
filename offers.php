...
function showUser(str) {
  ...
  xmlhttp.open("GET","getoffers.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >      <tr height="35px" bgcolor="#8fb242">
	  ...
	  <b>Price</b><br><br>
	  <input type="radio" name="price[]" value="between50and75" onClick="showUser(this.value)" >Rs50 and below<br>
	  <input type="radio" name="price[]" value="between75and100" onClick="showUser(this.value)" >Rs75 to Rs 100<br>
	  <input type="radio" name="price[]" value="between100and500" onClick="showUser(this.value)" >Rs100 and above
	  ...
	  <input type="radio" name="pack_size[]" value="100gm" onClick="showUser(this.value)">100gm-500gm<br>
