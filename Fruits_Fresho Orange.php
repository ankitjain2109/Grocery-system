...
<form method="post" action="Fruits_Fresho Orange.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="373" height="275"><br>
      <img src="Pj/fruits/orange-nagpur.jpg" class="effectscale" width="260" height="254" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="415" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho Orange</i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 84<form action="cart_update.php" method="post">
  ...
  <tr>
  <tr ><input type="hidden" name="product_name" value="Fresh Orange">
	<input type="hidden" name="product_price" value="84">
	<input type="hidden" name="product_imgname" value="Pj/fruits/orange-nagpur.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="ora" />';
    ...
    <td height="673" colspan="4">
	 ...
	 Nagpur Oranges are unique in taste, color and are rich in nutrients and antioxidants. Oranges are high in Vitamin C which helps to reduce the incidence of Peptic Ulcers and Stomach Cancer. The strong content of Vitamin C stimulates white cells to fight against infection, naturally helps to build a good immune system.Fresho is our brand of fresh fruits and vegetables which are individually handpicked everyday by our experienced and technically competent buyers. Our buying, storing and packaging processes are tailored to ensure that only the fresh, nutrient dense, healthy and delicious produce reaches your doorstep. We guarantee the quality of all Fresho products. If you're not satisfied with the freshness of the items, you can hand them back to our Customer Experience Executive (CEE) for a full refund.
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshoorange'; // required: replace example with your forum shortname
