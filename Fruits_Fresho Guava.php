...
{
	document.getElementById("txtHint3").innerHTML="	Guava is a somewhat round or pear-shaped regular fruit, and is yellow, light green or maroon in color on the outside when it is ripe. It also has white or maroon flesh and lots of small hard seeds covered in very supple, sweet pulp. It is eaten raw (ripe or semi-ripe) or in the form of jams and jellies."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="The health benefits of guava include the treatment of diarrhea, dysentery, constipation, cough, cold, skin care, high blood pressure, weight loss and scurvy."
	}
</script>
...
<form method="post" action="Fruits_Fresho Guava.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/guava.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho Guava</i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 97<?php ?><form action="cart_update.php" method="post">
  ...
  <tr>
  <tr ><input type="hidden" name="product_name" value="Fresh Guava">
	<input type="hidden" name="product_price" value="97">
	<input type="hidden" name="product_imgname" value="Pj/fruits/guava.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="guava" />';
    ...
    <td height="673" colspan="4">
		...
		<br><br>
		<p><button value="About" border="1px" onClick="showUserabout();" type="button" style="background-color:#FFFFFF; width:70px; height:40px">About</button>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
			 Guava is a somewhat round or pear-shaped regular fruit, and is yellow, light green or maroon in color on the outside when it is ripe. It also has white or maroon flesh and lots of small hard seeds covered in very supple, sweet pulp. It is eaten raw (ripe or semi-ripe) or in the form of jams and jellies.
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
  <script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshoguava'; // required: replace example with your forum shortname
