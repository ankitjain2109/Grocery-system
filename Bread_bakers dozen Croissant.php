...
{
	document.getElementById("txtHint3").innerHTML="1 of the world's favourite French breads, some count my 25 layers, some talk about the flavour. Others try me with coffee & get lost in my sweetness!No chemicals, No preservatives;Contains egg"
	}
...
<form method="post" action="Bread_bakers dozen Croissant.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr >
  <br>
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp; Bread Dairy & Eggs</font>	</tr>
  <tr>
  <tr >
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/the-bakers-dozen-croissant.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Bakers Dozen: Croissant</i><br><i>65 gm Pouch</i> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 65<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="The Bakers Dozen Croissant">
	<input type="hidden" name="product_price" value="65">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/the-bakers-dozen-croissant.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="cros" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i> Croissant</i>
		...
		<button value="Ingredients" type="button" border="1px" onClick="showUseringredients()" style="background-color:#FFFFFF; width:70px; height:40px">Ingredients</button>
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		1 of the world's favourite French breads, some count my 25 layers, some talk about the flavour. Others try me with coffee & get lost in my sweetness!No chemicals, No preservatives;Contains egg
		</td>
		</tr>
		</table>
...
<div id="disqus_thread"></div>
    <script type="text/javascript">
        ...
        var disqus_shortname = 'breadbakersdozencroissant'; // required: replace example with your forum shortname
