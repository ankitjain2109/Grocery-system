...
function showUser(str) {
  ...
  xmlhttp.open("GET","gethaircare.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="hair_care_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
	  ...
	  <input type="radio" name="price[]" value="between101and200" onClick="showUser(this.value)" >Rs101 to Rs200<br>
	  <input type="radio" name="price[]" value="between200and500" onClick="showUser(this.value)" >Rs200 and above<br>
	  ...
	  <input type="radio" name="pack_size[]" value="50ml" onClick="showUser(this.value)">50ml-100ml<br>
	  <input type="radio" name="pack_size[]" value="100ml" onClick="showUser(this.value)">100ml-150ml<br>
	  <input type="radio" name="pack_size[]" value="150ml" onClick="showUser(this.value)">150ml-200ml<br>
	   <input type="radio" name="pack_size[]" value="200ml" onClick="showUser(this.value)">200ml-250ml<br>
	  </tr>
	  <tr >
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; HAIR CARE &nbsp;&nbsp;
