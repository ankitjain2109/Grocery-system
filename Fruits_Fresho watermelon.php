...
{
	document.getElementById("txtHint3").innerHTML="Red Globe grapes are uniquely large and round. They have large seeds, a crunchy skin and fleshy pulp and are pinkish red in color. These are mildly sweet and tasty. They are not as tangy as flame seedless or as sweet as Thompson seedless."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Red grapes possess antibacterial and antiviral properties. Thus, they protect you from many infections. Red grapes are useful for reducing uric acid. These help to eliminate the acid from the system and reduce the work pressure of the kidneys."
	}
</script>
...
<form method="post" action="Fruits_Fresho watermelon.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/water-melon-kiran.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho  watermelon</i>
	<br><i>1 pc</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 58<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Fresh WaterMelon">
	<input type="hidden" name="product_price" value="58">
	<input type="hidden" name="product_imgname" value="Pj/fruits/water-melon-kiran.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="wat" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<!--<button value="Benefits" border="1px" onClick="showUseringredients();" style="background-color:#FFFFFF; width:70px; height:40px">Benefits</button>-->
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
  Watermelon Kiran is a smaller range of watermelons, oblong in shape with a dark green banded rind and pinkish-red flesh, interspersed with numerous brownish-black seeds. This variety includes a thinner rind than other varieties of watermelon. The flesh is sugary, juicy with a grainy texture.
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshowatermelon'; // required: replace example with your forum shortname
