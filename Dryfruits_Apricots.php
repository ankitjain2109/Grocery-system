...
{
	document.getElementById("txtHint3").innerHTML="Apricots are tiny drupes that resemble peaches or plums. They contain a spongy, tangy flesh beneath a thin outer skin. In the middle of the apricot is a great pit, which is inedible, so being cautious when taking that first large bit. They are normally yellow or orange, with a slight hint of red on one side. Apricots, clean and canned food, especially in dry, antioxidants that aid avoid heart disease. They can be enjoyed in a broad variety of ways, and every culture delights apricots differently.Apricots can be consumed raw and are commonly used in desserts and baked goods."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="These berries are high in fiber healthy, rich in beta carotene, as well as a number of nutrients for health. Apricots are rich in vitamin A, which is a powerful antioxidant, prevents free radical damage in tissues and cells. Especially in the eyes and vision are very useful, such as free radicals can act in Qatar and macular degeneration and destruction of blood flow leading to the eye.It is obvious that fruits rich in vitamin A, carrots are a better appearance."
	}
</script>
...
<form method="post" action="Dryfruits_Apricots.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr >
  <br>
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;  Dry Fruits </font>	
  </tr>
  <tr>
  <tr >
  ...
  <tr>
    <td width="390" height="275"><br>
      <img src="Pj/dry fruits/royal-apricots.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="398" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Apricots  </i>
	<br><i>100gm Tray</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 86<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Royal Apricots">
	<input type="hidden" name="product_price" value="86">
	<input type="hidden" name="product_imgname" value="Pj/dry fruits/royal-apricots.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="apri" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br><br>
		<p><button value="About" border="1px" type="button" onClick="showUserabout()" style="background-color:#FFFFFF; width:70px; height:40px">About</button>
		<button value="Benefits" border="1px" type="button" onClick="showUseringredients()" style="background-color:#FFFFFF; width:70px; height:40px">Benefits</button>
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Apricots are tiny drupes that resemble peaches or plums. They contain a spongy, tangy flesh beneath a thin outer skin. In the middle of the apricot is a great pit, which is inedible, so being cautious when taking that first large bit. They are normally yellow or orange, with a slight hint of red on one side. Apricots, clean and canned food, especially in dry, antioxidants that aid avoid heart disease. They can be enjoyed in a broad variety of ways, and every culture delights apricots differently.Apricots can be consumed raw and are commonly used in desserts and baked goods.
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
   <script type="text/javascript">
        ...
        var disqus_shortname = 'dryfruitsapricots'; // required: replace example with your forum shortname
