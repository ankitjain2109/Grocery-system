...
$sql=mysql_query("select * from offers where product_name='organa-organic-drink-refreshing-apple'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Organa Organic Drink - Refreshing Apple, 1 ltr Bottle."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Bromelain has anti-inflammatory properties and also reduces swelling caused due to inflammation. It also helps regulate the secretions in the pancreas to aid in digestion. It is a immune booster, prevents colds & coughs, strengthens bones."
	}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/offers/organa-organic-drink-refreshing-apple.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr >
    <td height="673" colspan="4">
		...
		Organa Organic Drink - Refreshing Apple, 1 ltr Bottle
