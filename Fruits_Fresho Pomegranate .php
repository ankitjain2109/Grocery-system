...
{
	document.getElementById("txtHint3").innerHTML="Pomegranate Kesar have been respected as a symbol of fertility & health. This variety has a vibrant, soft ruby-red skin and shiny. This nutrient dense, antioxidant rich fruit is considered to be a super-food; just one glass of pomegranate juice has more antioxidants. It is rich supply of soluble and insoluble dietary fibers. It is a fine supply of vitamin K, C, minerals and B-complex vitamins such as B5, B6."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="It is good for pregnant women going through the process of cell growth and division during the pregnancy. It prevents brain damage to the baby due to insufficient blood flow.It has antibacterial properties which protects the body from influenza, several bacteria. It maintains a healthy heart."
	}
</script>
...
<form method="post" action="Dryfruits_Walnuts.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr >
  <br>
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;Cut Vegetables & Fruits > Fruits   </font>	
  </tr>
  <tr>
  <tr >
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/pomegranate-kesar.jpg" class="effectscale" width="283" height="254" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho Pomegranate</i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 201<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Fresh Pomegranate">
	<input type="hidden" name="product_price" value="201">
	<input type="hidden" name="product_imgname" value="Pj/fruits/pomegranate-kesar.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="pome" />';
 ...
 Pomegranate Kesar have been respected as a symbol of fertility & health. This variety has a vibrant, soft ruby-red skin and shiny. This nutrient dense, antioxidant rich fruit is considered to be a super-food; just one glass of pomegranate juice has more antioxidants. It is rich supply of soluble and insoluble dietary fibers. It is a fine supply of vitamin K, C, minerals and B-complex vitamins such as B5, B6.
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshopomegranate'; // required: replace example with your forum shortname
