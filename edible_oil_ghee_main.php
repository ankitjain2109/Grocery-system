...
function showUser(str) {
  ...
  xmlhttp.open("GET","getedible.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="edible_oil_ghee_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
	  ...
	  <input type="radio" name="pack_size[]" value="200gm" onClick="showUser(this.value)">200ml<br>
	  <input type="radio" name="pack_size[]" value="250gm" onClick="showUser(this.value)">250ml<br>
	  <input type="radio" name="pack_size[]" value="500gm" onClick="showUser(this.value)">500ml<br>
	  <input type="radio" name="pack_size[]" value="1kg" onClick="showUser(this.value)">1Lt<br>
	  </tr>
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; EDIBLE OIL & GHEE&nbsp;&nbsp;
