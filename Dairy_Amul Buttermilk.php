...
<form method="post" action="Dairy_Amul Buttermilk.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/dairy products/amul-masti-buttermilk-spice.jpg" class="image1" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Amul ButterMilk   </i>
	<br><i>1 lt</i><br> <?php ?>
	</b>
	<br>
	<br>
  ...
  <tr><input type="hidden" name="product_name" value="Amul ButterMilk">
	<input type="hidden" name="product_price" value="75">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/amul-masti-buttermilk-spice.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="buttermilk" />';
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
  <script type="text/javascript">
        ...
        var disqus_shortname = 'dairyamulbuttermilk'; // required: replace example with your forum shortname
