...
<form method="post" action="Bread_bakeshop Kharis whole wheat bread.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/the-bake-shop-kharis-whole-wheat.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Bake Shop Bread - Kharis Whole Wheat Sliced (High Fibre) </i>
	<br><i>400 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
  ...
  <tr><input type="hidden" name="product_name" value="Bake Shop Bread - Kharis Whole Wheat Sliced (High Fibre) ">
	<input type="hidden" name="product_price" value="25">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/the-bake-shop-kharis-whole-wheat.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="kharis" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i> The Bake Shop Bread</i>
		...
		A specially prepared Khari made with whole wheat flour. This product is a healthy, high fibre option for a lite evening snack.
		</td>
		</tr>
		</table>
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'breadbakeshopkhariswholewheatbread'; // required: replace example with your forum shortname
