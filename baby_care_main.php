...
function showUser(str) {
  ...
  xmlhttp.open("GET","getbabycare.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
window.mm_menu_1005154101_0_1 = new Menu("Dals&nbsp;&&nbsp;Pulses",200,30,"Arial, Helvetica, sans-serif",14,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1005155710_0.addMenuItem("Eggs","location='eggs_main.php'");
   ...
   mm_menu_1005155710_0.menuBorderBgColor='#CCCCCC';
    ...
    mm_menu_1005160226_0_1.addMenuItem("Syup&nbsp;&&nbsp;Squashes","location='syrup_squashes_main.php'");
...
<form method="post" action="baby_care_main.php">
...
<th></th><th><a href="main.php"><img src="Pj/admin/logo.jpg" align="middle" class="image2" style="size:landscape; height: 125px; width:240px"/></a></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="text" name="search" class="image2" width="300px" height="200px" size="+60" placeholder="&nbsp;&nbsp;&nbsp;Search your needs" style="border-radius:8px; height:25px; width:500px";/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="submit" name="srchbutton" value="SEARCH" class="image2" style="height:25px; width:80px"/></th>&nbsp;&nbsp;&nbsp;<th style="background-color:#f5f4f4"><span><a href="view_cart.php" style="text-decoration:none">Your Basket Has <?php echo $_SESSION['count']; ?> Item<br> <img src="Pj/bskt.jpg" height="36px"/> </span>
	...
	<table width="170px" height="800px" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
	  ...
	  <input type="radio" name="price[]" value="between100and200" onClick="showUser(this.value)" >Rs100 to Rs 200<br>
	  <input type="radio" name="price[]" value="between200and300" onClick="showUser(this.value)" >Rs200 to 300<br>
	    <input type="radio" name="price[]" value="between300and400" onClick="showUser(this.value)" >Rs300 to 400
	  ...
	  <tr height="50px">
	  <td >&nbsp;
	  <b style="text-align:justify;">Specififcations</b><br><br>
	  
	  <input type="radio" name="pack_size[]" value="50cm" onClick="showUser(this.value)">70cm X 50cm<br>
	
	  <input type="radio" name="pack_size[]" value="100cm" onClick="showUser(this.value)">70cm X 100cm<br>
	...
	<a style="text-decoration:none" href="new_arrival.php">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; BABY CARE
	   ...
	   <option style="background-color:#8FB242; text-align:center" value="" >&nbsp;&nbsp;--View By--</option>
         ...
         <option style="background-color:#8FB242" value="alphabetical">Alphabetical</option>
       </select></td>
    </tr>
