...
function showUser(str) {
  ...
  xmlhttp.open("GET","getdiary.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="diary_products_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226px" height="800px" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
	  ...
	  <input type="radio" name="pack_size[]" value="150gm" onClick="showUser(this.value)">150gm<br>
	
	  <input type="radio" name="pack_size[]" value="200gm" onClick="showUser(this.value)">200gm<br>
	  <input type="radio" name="pack_size[]" value="500gm" onClick="showUser(this.value)">500gm<br>
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; DIARY PRODUCTS
