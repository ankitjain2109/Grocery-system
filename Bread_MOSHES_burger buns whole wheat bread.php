...
{
	document.getElementById("txtHint3").innerHTML="	  whole Wheat Flour, Bran Sugar ,Anti Caking Agent - E341, Permitted Baking Enzyme, Oat, Vegetable Fat, Salt, Yeast, Wheat Gluten, Wheat Flour Emulsifiers E472E, Cracked Wheat, Flour Treatment Agent E300 & Calcium Propionate"
	}
...
<form method="post" action="Bread_MOSHES whole wheat bread.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/moshes-burger-buns-whole-wheat.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Moshes Bread - Burger Buns Whole Wheat   </i>
	<br><i>180 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 40<form action="cart_update.php" method="post">
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">&nbsp;&nbsp;<input type="submit" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD">	
	</td >
  <tr><input type="hidden" name="product_name" value="Moshes Burger Buns Whole Wheat">
	<input type="hidden" name="product_price" value="40">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/moshes-burger-buns-whole-wheat.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="burbun" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i> MOSHES burger buns  Bread</i>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 whole Wheat Flour, Bran Sugar ,Anti Caking Agent - E341, Permitted Baking Enzyme, Oat, Vegetable Fat, Salt, Yeast, Wheat Gluten, Wheat Flour Emulsifiers E472E, Cracked Wheat, Flour Treatment Agent E300 & Calcium Propionate
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
  <script type="text/javascript">
        ...
        var disqus_shortname = 'breadmoshesburgerbunswholewheatbread'; // required: replace example with your forum shortname
