...
$sql=mysql_query("select * from new_arrival where product_name='aashirvaad-atta-whole-wheat'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Aashirvaad Whole Wheat Flour is finished from the best accepted ingredients that help recover digestion and offer good number of well nutrients to the body. Aashirvaad Whole Grain Atta does not hold any extra preservatives or flavours. 100% full Wheat Chapati Flour and no Maida added."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="(per 200 g) Calories 678 Total Fat 4 g Saturated 1 g Polyunsaturated 0 g Monounsaturated 0 g Trans 0 g Cholesterol 0 mg Sodium 10 mg Potassium 0 mg Total Carbs 145 g Dietary Fiber 24 g Sugars 1 g Protein 27 g"
	}
...
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/new arrivals/aashirvaad-atta-whole-wheat.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
	...
	<input type="hidden" name="product_imgname" value="Pj/new arrivals/<?php echo $res['img_name'];?>">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="atta" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<button value="Facts" type="button" border="1px" onClick="showUseringredients();" style="background-color:#FFFFFF; width:70px; height:40px">Facts</button>
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
	Aashirvaad Whole Wheat Flour is finished from the best accepted ingredients that help recover digestion and offer good number of well nutrients to the body. Aashirvaad Whole Grain Atta does not hold any extra preservatives or flavours. 100% full Wheat Chapati Flour and no Maida added
