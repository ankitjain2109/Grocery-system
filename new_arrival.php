...
function showUser(str) {
  ...
  xmlhttp.open("GET","getarrival.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="hair_removal_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >      <tr height="35px" bgcolor="#8fb242">
	  ...
	  <input type="radio" name="pack_size[]" value="50gm" onClick="showUser(this.value)">50gm-500gm<br>
	  <input type="radio" name="pack_size[]" value="1kg" onClick="showUser(this.value)">1Kg and above<br>
	  <input type="radio" name="pack_size[]" value="oth" onClick="showUser(this.value)">Others<br>
