...
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="(Cheese, Sodium citrate, Common salt, Citric acid, Permitted natural color (Annatto), and Class II preservatives."
	}
</script>
...
<form method="post" action="Dairy_Amul Cheese.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/dairy products/amul-processed-cheese-block.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Amul  Processed Cheese  </i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 357<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Amul Processed Cheese">
	<input type="hidden" name="product_price" value="357">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/amul-processed-cheese-block">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="proche" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Amul Cheese</i>
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'dairyamulcheese'; // required: replace example with your forum shortname
