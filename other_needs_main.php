...
function showUser(str) {
  ...
  xmlhttp.open("GET","getotherneeds.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >      <tr height="35px" bgcolor="#8fb242">
	  ...
	  <b>Price</b><br><br>
	    ...
	    <input type="radio" name="price[]" value="between50and100" onClick="showUser(this.value)" >Rs50 to 100<br>
	  <input type="radio" name="price[]" value="between100and200" onClick="showUser(this.value)" >Rs100 to Rs 200<br>
	  <input type="radio" name="price[]" value="between200and500" onClick="showUser(this.value)" >Rs200 to 500<br>
	    <input type="radio" name="price[]" value="between500and1000" onClick="showUser(this.value)" >Rs500 to 1000<br>
	    <input type="radio" name="price[]" value="above1000" onClick="showUser(this.value)" >Rs1000 and above<br>
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; OTHER NEEDS &nbsp;&nbsp;&nbsp;
