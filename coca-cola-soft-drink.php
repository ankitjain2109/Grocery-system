...
$sql=mysql_query("select * from offers where product_name='coca-cola-soft-drink'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Nothing beats the heat like a glass of a refreshing cold Coca Cola soft drink. Even during winters, it is fun to drink cola. The taste is so yummy and it goes well with almost anything. You can’t watch a movie without a cola drink"
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Carbonated Water, Sugar and Acidity Regulator (338)."
	}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/offers/coca-cola-soft-drink.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
    ...
    echo '<input type="hidden" name="product_code" value="coke" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Nothing beats the heat like a glass of a refreshing cold Coca Cola soft drink. Even during winters, it is fun to drink cola. The taste is so yummy and it goes well with almost anything. You can’t watch a movie without a cola drink
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'cocacolasoftdrink'; // required: replace example with your forum shortname
