...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="TangyOrange Flavour with Vitamin C"
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Nutritional Value: Calcium 114 mg, Phosphorus 57 mg, Vitamin C 50 mg, Energy Value 368 kcal, Protein 0g, Carbohydrates 92g, Of which sugar (Sucrose) 56g, Fat & All types of fatty Acids 0g"
	}
</script>
...
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    ...
    <td height="275"><br><img src="Pj/energy and drink/glucon-d-pure-glucose-tangy-orange.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Glucon-D Pure Glucose - Tangy Orange</i><br><i>500 ml</i> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 115<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Glucon-d Pure Glucose Tangy Orange">
	<input type="hidden" name="product_price" value="115">
	<input type="hidden" name="product_imgname" value="Pj/energy and drink/glucon-d-pure-glucose-tangy-orange.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="glcdt" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Glucon-D Pure Glucose - Tangy Orange</i>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 TangyOrange Flavour with Vitamin C
...
<p style="width:50%">
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'glucondorangeflavour'; // required: replace example with your forum shortname
