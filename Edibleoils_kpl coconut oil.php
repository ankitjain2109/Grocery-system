...
{
	document.getElementById("txtHint3").innerHTML="The people once experienced the difference vouch for the quality it stands for. And the excellent words from their mouth spread unstopped like the fragrance of pure coconut oil, creating KPL Sudhi Coconut oil as a first preference among the coconut oil brands."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="100% Natural coconut oil of edible grade."
	}
</script>
...
<form method="post" action="Edibleoils_kpl coconut oil.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/edible oils & ghee/shudhi-coconut-oil.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Kpl Shudhi - Coconut Oil  </i>
	<br><i>1 lt Tray</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 266<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value=" Shudhi Coconut Oil">
	<input type="hidden" name="product_price" value="266">
	<input type="hidden" name="product_imgname" value="Pj/edible oils & ghee/shudhi-coconut-oil.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="shudhi" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
			 The people once experienced the difference vouch for the quality it stands for. And the excellent words from their mouth spread unstopped like the fragrance of pure coconut oil, creating KPL Sudhi Coconut oil as a first preference among the coconut oil brands.		  	</td>
		</tr>
		</table>	</td>
    </tr>
  </table>
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'edibleoilskplcoconutoil'; // required: replace example with your forum shortname
