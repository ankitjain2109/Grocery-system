...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
      ...
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link17" id="link11" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005162054_0,216,11,null,'link17')" onMouseOut="MM_startTimeout();">PERSONAL CARE<img src="../Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
  ...
  <table id='tab' vspace="20px" width="800px" height="800px" class="image1">
  <tr align="center" >
  	<td>
...
if(isset($_SESSION["products"]))
{
    $total = 0;
    echo '<ol>';
  		echo "<table align='right' width='100%'><tr>";
		echo "<th style='width:30%'>";
		echo "Image";
		echo "</th>";
		echo "<th style='width:46%'>";
		echo "Name";
		echo "</th>";
    ...
    foreach ($_SESSION["products"] as $cart_itm)
    {
		...
		echo "<td>";		
		echo "<ul align='left'>";
		echo '<li align="left" class="cart-itm">';	
		echo "<td align='left' style='width:30%'>";
		echo '<div align="left" class="p-code"><img class="image1" src="'.$cart_itm["imgname"].'"  height="155px" width="155px"></div>';
        echo "</td>";
		echo "<td align='left' style='width:40%'>";
	    echo '<h3 align="left">'.$cart_itm["name"].'</h3>';
        echo "</td>";
		echo "<td align='left'  style='width:8%'>";
		echo '<div class="p-qty">&nbsp;&nbsp;Qty : '.$cart_itm["qty"].'</div>';
		echo "</td>";
		echo "<td align='left' style='width:18%'>";
        echo '<div class="p-price" align="right">&nbsp;&nbsp;&nbsp;Price :'.$currency.$cart_itm["price"].'</div>';
        echo "<td>";
		echo '<span class="remove-itm" align="right">&nbsp;&nbsp;&nbsp;<a href="cart_update.php?removep='.$cart_itm["code"].'&return_url='.$current_url.'">&times;</a>&nbsp;&nbsp;&nbsp;</span>';
		echo '</li>';
		echo "</ul>";
		echo "</td>";
		echo "</tr>";
	...
	echo "<form method='post' action='view_cart.php'>";
		echo "<br/>";
			echo "<br/>";
		echo "<input type='submit' name='checkout' value='checkout!!' class='pulse-shrink image1' id='box' height='25px' width='40px'/>";
	echo "</form>";	
	...
	echo '<span class="empty-cart"><a  class="pulse-shrink image1" id="box" style="text-decoration:none; height:25px; width:120px;" href="cart_update.php?emptycart=1&return_url='.$current_url.'">&nbsp;&nbsp;&nbsp;Empty Cart</a></span>';
}else{
