...
{
	document.getElementById("txtHint3").innerHTML="Pistachios are tiny and delicious nuts enclosed in shells. These are an outstanding and rich tasting nut. It as they are sometimes called are well-liked because of their little size, green colour and simple to open shells."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="Pista helps in the production of haemoglobin but also boosts your immunity. It helps in eliminating dryness from the skin. Infections are averted as these help remove toxins from the body which by extension promotes healthy skin."
	}
</script>
...
<form method="post" action="Dryfruits_Pista.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/dry fruits/royal-plain-pista.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Pista  </i>
	<br><i>100gm Tray</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 267<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Royal Plain Pista">
	<input type="hidden" name="product_price" value="267">
	<input type="hidden" name="product_imgname" value="Pj/dry fruits/royal-plain-pista.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="piss" />';
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'dryfruitspista'; // required: replace example with your forum shortname
