...
{
	document.getElementById("txtHint3").innerHTML="Keggs Infertile Eggs These eggs come from hens whose diet comprises maize, rice derivatives, soya, sunflower, limestone, vitamins and other organic plant materials. Their diet does not contain antibiotics, growth promotes, synthetic stimulants, hormones, chemical yolk colouring pigmenters or any such substances."
	}
...
<form method="post" action="Eggs_ Keggs eggs.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/dairy products/keggs-eggs-infertile.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Keggs Eggs  </i>
	<br><i>6 pcs</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 95<form method="post" action="cart_update.php">
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty" min="1" max="10">&nbsp;&nbsp;<button  style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" >ADD</button>	
	<input type="hidden" name="product_name" value="Keggs Eggs">
	<input type="hidden" name="product_price" value="95">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/keggs-eggs-infertile.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="keggsinf" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br><br>
		<p><button value="About" type="button" border="1px" type="button" onClick="showUserabout()" style="background-color:#FFFFFF; width:70px; height:40px">About</button>
		...
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">Keggs Infertile Eggs These eggs come from hens whose diet comprises maize, rice derivatives, soya, sunflower, limestone, vitamins and other organic plant materials. Their diet does not contain antibiotics, growth promotes, synthetic stimulants, hormones, chemical yolk colouring pigmenters or any such substances.
		  	</td>
		</tr>
		</table>
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
  <script type="text/javascript">
        ...
        var disqus_shortname = 'eggskeggseggs'; // required: replace example with your forum shortname
