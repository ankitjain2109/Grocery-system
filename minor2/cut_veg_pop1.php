...
window.mm_menu_1004170146_0 = new Menu("root",277,23,"Arial, Helvetica, sans-serif",17,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",3,0,1000,-5,7,true,true,true,0,false,true);
  ...
  mm_menu_1004170146_0.addMenuItem("Customer&nbsp;Speak");
   ...
   mm_menu_1004170146_0.menuBorderBgColor='#000000';
                    window.mm_menu_1004173024_0_1 = new Menu("Fruits",250,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E62E1A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    mm_menu_1004173024_0_1.addMenuItem("Other&nbsp;Fruits");
     ...
     mm_menu_1004173024_0_1.menuBorderBgColor='#CCCCCC';
      window.mm_menu_1004173024_0_2_1 = new Menu("Vegetables",250,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E62E1A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1004173024_0_2 = new Menu("Organic&nbsp;F&V",250,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E62E1A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1004173024_0 = new Menu("root",250,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E62E1A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1004173024_0.addMenuItem(mm_menu_1004173024_0_2);
   ...
   mm_menu_1004173024_0.menuBorderBgColor='#CCCCCC';
    window.mm_menu_1005154101_0_1 = new Menu("Dals&nbsp;&&nbsp;Pulses",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005154101_0_2 = new Menu("Dry&nbsp;Fruitts",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005154101_0_3 = new Menu("Edible&nbsp;Oils&nbsp;&&nbsp;Ghee",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005154101_0_4 = new Menu("Masala&nbsp;&&nbsp;Spices",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005154101_0_5 = new Menu("Rice&nbsp;&&nbsp;Rice&nbsp;Products",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1005154101_0 = new Menu("root",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1005154101_0.addMenuItem("Salt,Sugar&nbsp;&&nbsp;Jaggery");
   ...
   mm_menu_1005154101_0.menuBorderBgColor='#FFFFFF';
    window.mm_menu_1005155710_0_1 = new Menu("Bread&nbsp;&&nbsp;Bakery",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FCFAF9","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005155710_0_2 = new Menu("Diary&nbsp;Products",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FCFAF9","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1005155710_0 = new Menu("root",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FCFAF9","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1005155710_0.addMenuItem("Eggs");
   ...
   mm_menu_1005155710_0.menuBorderBgColor='#CCCCCC';
    window.mm_menu_1005160226_0_1 = new Menu("Fruit&nbsp;Drinks&nbsp;&&nbsp;Juices",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005160226_0_2 = new Menu("Mineral&nbsp;Water",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005160226_0_3 = new Menu("Organic&nbsp;Juices&nbsp;&&nbsp;Tea",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1005160226_0 = new Menu("root",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1005160226_0.addMenuItem(mm_menu_1005160226_0_3);
   ...
   mm_menu_1005160226_0.menuBorderBgColor='#CCCCCC';
    window.mm_menu_1005160918_0_1 = new Menu("Baking&nbsp;&&nbsp;Dessert&nbsp;Items",277,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005160918_0_2 = new Menu("Biscuits",277,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005160918_0_3 = new Menu("Breakfast&nbsp;Cereals",277,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005160918_0_4 = new Menu("Chocolates&nbsp;&&nbsp;Sweets",277,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005160918_0_5 = new Menu("Indian&nbsp;Sweets",277,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1005160918_0 = new Menu("root",277,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1005160918_0.addMenuItem(mm_menu_1005160918_0_5);
   ...
   mm_menu_1005160918_0.menuBorderBgColor='#CCCCCC';
            window.mm_menu_1005162054_0_1 = new Menu("Baby&nbsp;Care&nbsp;",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005162054_0_2 = new Menu("Cosmetics",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005162054_0_3 = new Menu("Deos&nbsp;&&nbsp;Perfumes",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005162054_0_4 = new Menu("Hair&nbsp;Care",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005162054_0_5 = new Menu("Skin&nbsp;Care",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    mm_menu_1005162054_0_5.addMenuItem("Foot&nbsp;Care");
     ...
     mm_menu_1005162054_0_5.menuBorderBgColor='#CCCCCC';
      window.mm_menu_1005162054_0_6_1 = new Menu("Cleaning&nbsp;Accessories",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
      ...
      window.mm_menu_1005162054_0_6_2 = new Menu("Detergents",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
      ...
      window.mm_menu_1005162054_0_6_3 = new Menu("Kitchen&nbsp;&&nbsp;Dining",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
      ...
      window.mm_menu_1005162054_0_6_4 = new Menu("Pooja&nbsp;Needs",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005162054_0_6 = new Menu("Household",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1005162054_0 = new Menu("root",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_1005162054_0.addMenuItem(mm_menu_1005162054_0_6);
   ...
   mm_menu_1005162054_0.menuBorderBgColor='#CCCCCC';
    window.mm_menu_1005164511_0_1 = new Menu("Chicken&nbsp;",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005164511_0_2 = new Menu("Mutton",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
    ...
    window.mm_menu_1005164511_0_3 = new Menu("Sea&nbsp;Food",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
  ...
  window.mm_menu_1005164511_0 = new Menu("root",278,40,"Arial, Helvetica, sans-serif",18,"#000000","#FFFFFF","#8FB242","#E61E2A","left","middle",0,0,1000,-5,7,true,true,true,0,false,false);
...
<div id="header" style="height:36px;width:100%; background-color:#ededed;" >
  <div id="loc"></div>
  <div id="slots"><img src="Pj/img8.jpg"><a name="link23" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1004165716_0,0,19,null,'link23')" onMouseOut="MM_startTimeout();"><b>Check our delivery slots</b></a></div>
  
  <div id="a">Free delivery for orders Rs1000 and above&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <a href="register.php" style="color:#FF0000;text-decoration:none">Register</a>  </div>
</div>

<table align="center">
<tr>
<th></th><th><img src="Pj/img5.jpg" align="middle" style="size:landscape; height: 60px; width:80px"/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="text" name="search" width="300px" height="200px" size="+60" placeholder="&nbsp;&nbsp;&nbsp;Search your needs" style="border-radius:8px; height:25px; width:500px";/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="button" name="srchbutton" value="SEARCH" style="height:25px; width:80px"/></th>&nbsp;&nbsp;&nbsp;<th style="background-color:#CCCCCC"><p>Your Basket Item</p><p style="font-size:12px;">Start Shopping <img src="Pj/arrows.gif"/> </p></th>
</tr>
</table>
<table width="1002px" height="1000px" hspace="168px" border="1px">
  <tr width="1002px" height="1000px">
    <td height="680px" width="170px" >
	<table  width="170px" height="1000px" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC;" >
      <tr height="35px" bgcolor="#8fb242">
        <td height="35px" style="color:#FFFFFF;">&nbsp;&nbsp;&nbsp;&nbsp; SHOP<img src="Pj/img9.jpg" align="right"></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link3" id="link4" style="font-size:11px;font-family:Arial, Helvetica, sans-serif;" onMouseOver="MM_showMenu(window.mm_menu_1004173024_0,150,0,null,'link3')" onMouseOut="MM_startTimeout();">FRUITS & VEGETABLES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link21" id="link5" style="font-size:11px; font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005154101_0,150,0,null,'link21')" onMouseOut="MM_startTimeout();">GROCERY & STAPLES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link22" id="link7" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005155710_0,150,0,null,'link22')" onMouseOut="MM_startTimeout();">BREAD DIARY & EGGS<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link8" id="link9" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005160226_0,150,0,null,'link8')" onMouseOut="MM_startTimeout();">BEVERAGES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link6" id="link10" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005160918_0,150,0,null,'link6')" onMouseOut="MM_startTimeout();">BRANDED FOODS<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link14" id="link11" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005162054_0,150,-200,null,'link14')" onMouseOut="MM_startTimeout();">PERSONAL CARE<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link16" id="link12" style="font-size:11px;font-family:Arial, Helvetica, sans-serif; " onMouseOver="MM_showMenu(window.mm_menu_1005164511_0,150,-78,null,'link16')" onMouseOut="MM_startTimeout();">MEAT<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a style="font-size:11px;font-family:Arial, Helvetica, sans-serif">OTHER NEEDS<img src="Pj/arrows.gif" align="right" height="10px" ></a></td>
      </tr>
	  <tr height="100px">
	  <td height="116" style="text-align:left;top:10px">&nbsp;
	  <b>Price</b><br><br>
	  <input type="checkbox" name="price[]" value="between21and50" >Rs21 to Rs 50<br>
	  <input type="checkbox" name="price[]" value="between51and100" >Rs51 to Rs 100<br>
	  <input type="checkbox" name="price[]" value="between101and200" >Rs101 to Rs 200
	  ...
	  <input type="checkbox" name="pack_size[]" value="100gm">100gm<br>
	  <input type="checkbox" name="pack_size[]" value="200gm">200gm<br>
	  <input type="checkbox" name="pack_size[]" value="250gm">250gm<br>
	  <input type="checkbox" name="pack_size[]" value="300gm">300gm<br>
	  <input type="checkbox" name="pack_size[]" value="350gm">350gm<br>
	  <input type="checkbox" name="pack_size[]" value="400gm">400gm<br>
	  </td>
	  </tr>
	  <tr >
	  <td height="68px">&nbsp;<b style="text-align:justify;">Discounts</b><br><br>
	  <input type="checkbox" name="dis" value="between5and10">5%-10%<br></td>
	  </tr>
    </table></td>
    <td width="819" height="1000px">
      <table width="819" style=" border:1px thin;border-color:#CCCCCC;"cellspacing="0" cellpadding="0">
  <tr height="58px" bgcolor="#8FB242">
    <td width="193px">&nbsp;
	<img src="Pj/img10.jpg">
	<a>OFFERS</a>	 </td>
    <td colspan="3">&nbsp;
	<img src="Pj/img11.jpg">
	<a>NEW ARRIVALS</a>	</td>
    </tr>
  <tr height="58px" >
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif"> CUT VEGETABLES</font> 
	<select id="sel" style="background-color: #CCCCCC;" size="1" name="view_by" ><option style="background-color:#8FB242" value="popularity">Popularity</option><option style="background-color:#8FB242" value="pricehightolow">Price-High to Low </option><option style="background-color:#8FB242" value="pricelowtohigh">Price- Low to High</option><option style="background-color:#8FB242" value="alphabetical">Alphabetical</option></select>	</td>
	</tr>
  <tr>
    <td height="275"><br><img src="" width="150px" height="125px" style="margin-top:-30px; margin-left:30px">
	<br><br>&nbsp;<b style="color:#CCCCCC;">FRESH:<?php ?></b>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs<?php ?>
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty">&nbsp;&nbsp;<input type="button" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD">
	</td>
    <td>&nbsp;<br> <img src="" width="150px" height="125px" style="margin-top:-30px; margin-left:30px"><br><br>&nbsp;<b style="color:#CCCCCC;">FRESH:<?php ?></b>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs<?php ?>
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty">&nbsp;&nbsp;<input type="button" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD"></td>
    <td >&nbsp;<br><img src="" width="150px" height="125px" style="margin-top:-30px; margin-left:30px"><br><br>&nbsp;<b style="color:#CCCCCC;">FRESH:<?php ?></b>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs<?php ?>
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty">&nbsp;&nbsp;<input type="button" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD"></td>
  ...
  <tr>
    <td  height="275" >&nbsp;<br><img src=""width="150px" height="125px" style="margin-top:-30px; margin-left:30px"><br><br>&nbsp;<b style="color:#CCCCCC;">FRESH:<?php ?></b>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs<?php ?>
	<br>&nbsp;&nbsp; Qty&nbsp;<input type="number" style="width:35px; height:15px;" name="qty">&nbsp;&nbsp;<input type="button" style="width:50px; height:40px; background-color:#FFCC66; border-radius:8px;" name="add" value="ADD"></td>
    <td>&nbsp;<br><img src=""width="150px" height="125px" style="margin-top:-30px; margin-left:30px"><br><br>&nbsp;<b style="color:#CCCCCC;">FRESH:<?php ?></b>
