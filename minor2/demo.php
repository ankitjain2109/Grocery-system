...
<div id="mn">
	<table  width="170px" height="1000px" border="1" hspace="168px" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC;" >
	...
	<select  id="sel"  name="view_by" onChange="showUser(this.value)" >
	...
	<div id="main"><img align="absmiddle" src="../cv.jpg"></div>
