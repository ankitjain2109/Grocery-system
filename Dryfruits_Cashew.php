...
{
	document.getElementById("txtHint3").innerHTML="	  Cashew nuts are rich in monounsaturated fatty acid and minerals such as iron, potassium, phosphorous, copper, zinc and selenium. They also contain god amounts of dietary fibre, oil and antioxidants. Being a good a source of iron they help prevent "anemia". The fat contained in the nut is healthy for the heart. They promote bone and teeth health, and aid digestion, and help boost the body's metabolism."
	}
...
<form method="post" action="Dryfruits_Cashew.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/dry fruits/shree-ram-spices-cashew-320.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Cashews  </i>
	<br><i>500gm Tray</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 540<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Shree Ram Spices Cashews">
	<input type="hidden" name="product_price" value="540">
	<input type="hidden" name="product_imgname" value="Pj/dry fruits/shree-ram-spices-cashew-320.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="cash" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Cashew nuts are rich in monounsaturated fatty acid and minerals such as iron, potassium, phosphorous, copper, zinc and selenium. They also contain god amounts of dietary fibre, oil and antioxidants. Being a good a source of iron they help prevent "anemia". The fat contained in the nut is healthy for the heart. They promote bone and teeth health, and aid digestion, and help boost the body's metabolism.
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
  <script type="text/javascript">
        ...
        var disqus_shortname = 'dryfruitscashew'; // required: replace example with your forum shortname
