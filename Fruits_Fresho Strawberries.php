...
<form method="post" action="Fruits_Fresho Strawberries.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/strawberry.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho  Strawberries</i>
	<br><i>200 gm</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 54<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Fresh Strawberries">
	<input type="hidden" name="product_price" value="54">
	<input type="hidden" name="product_imgname" value="Pj/fruits/strawberry.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="stra" />';
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
   <script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshostrawberries'; // required: replace example with your forum shortname
