...
function showUser(str) {
  ...
  xmlhttp.open("GET","getbleach.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="bleach_main.php">
...
<th></th><th><a href="main.php"><img src="Pj/admin/logo.jpg" align="middle" class="image2" style="size:landscape; height: 125px; width:240px"/></a></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="text" name="search" class="image2" width="300px" height="200px" size="+60" placeholder="&nbsp;&nbsp;&nbsp;Search your needs" style="border-radius:8px; height:25px; width:500px";/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="submit" name="srchbutton" value="SEARCH" class="image2" style="height:25px; width:80px"/></th>&nbsp;&nbsp;&nbsp;<th style="background-color:#f5f4f4"><span><a href="view_cart.php" style="text-decoration:none">Your Basket Has <?php echo $_SESSION['count']; ?> Item<br> <img src="Pj/bskt.jpg" height="36px"/> </span>
	...
	<table width="170px" height="800px" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
	  ...
	  <input type="radio" name="pack_size[]" value="5gm" onClick="showUser(this.value)">5gm-20gm<br>
	
	  <input type="radio" name="pack_size[]" value="20gm" onClick="showUser(this.value)">20-50gm<br>
	  <input type="radio" name="pack_size[]" value="50gm" onClick="showUser(this.value)">50gm-100gm<br>
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a style="text-decoration:none;" href="new_arrival.php">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; BLEACH
