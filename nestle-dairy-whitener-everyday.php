...
$sql=mysql_query("select * from new_arrival where product_name='nestle-dairy-whitener-everyday'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Nestle Every Day Dairy Whitener is identified for its rich flavor and finest quality. It has high dietary value so it is a beloved drink for each one. It has rich nutritive rate and supplies body building proteins, bone forming minerals, and fitness giving vitamins and furnishes energy giving lactose and milk fat.."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="(per 100 g) Calories: 139 kcal Sodium: 0 mg Total Fat: 5.7 g Saturated Fat: 0 g Total Carbs: 0 g Sugars: 21 g Protein: 19 g Cholesterol: 0 mg Total Carbohydrate: 15.81 g Protein: 6.15 g."
	}
...
Nestle Every Day Dairy Whitener is identified for its rich flavor and finest quality. It has high dietary value so it is a beloved drink for each one. It has rich nutritive rate and supplies body building proteins, bone forming minerals, and fitness giving vitamins and furnishes energy giving lactose and milk fat.
