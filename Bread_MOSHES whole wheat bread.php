...
{
	document.getElementById("txtHint3").innerHTML="	 Whole Wheat Flour, Wheat Flour,Cracked Wheat, Oat Bran, Salt, Sugar, Yeast, Wheat Gluten, Vegetable Fat, Emulsifiers - E472E, Anti Caking Agent - E341, Permitted Baking Enzyme, Flour Treatment Agent E300 & Calcium Propionate"
	}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/moshes-bread-whole-wheat.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Moshes Bread - Whole Wheat   </i>
	<br><i>400 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 45<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Moshes Whole Wheat Bread">
	<input type="hidden" name="product_price" value="45">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/moshes-bread-whole-wheat.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="mosbred" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>MOSHES Bread</i>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Whole Wheat Flour, Wheat Flour,Cracked Wheat, Oat Bran, Salt, Sugar, Yeast, Wheat Gluten, Vegetable Fat, Emulsifiers - E472E, Anti Caking Agent - E341, Permitted Baking Enzyme, Flour Treatment Agent E300 & Calcium Propionate
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
  <script type="text/javascript">
        ...
        var disqus_shortname = 'breadmosheswholewheatbread'; // required: replace example with your forum shortname
