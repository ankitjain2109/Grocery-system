...
{
	document.getElementById("txtHint3").innerHTML="	   All Purpose Flour, Butter, Yeast"
	}
...
<form method="post" action="Bread_MOSHES  bread white.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/moshes-bread-white.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Moshes Bread White </i>
	<br><i>400 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 30<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Moshes Bread White">
	<input type="hidden" name="product_price" value="30">
	<input type="hidden" name="product_imgname" value="Pj/dairy products/moshes-bread-white.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="whibred" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>  MOSHES Bread White</i>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 All Purpose Flour, Butter, Yeast
		  	</td>
		</tr>
		</table>
...
<p style="width:50%">
 ...
 <script type="text/javascript">
        ...
        var disqus_shortname = 'breadmoshesbreadwhite'; // required: replace example with your forum shortname
