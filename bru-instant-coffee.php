...
$sql=mysql_query("select * from offers where product_name='bru-instant-coffee'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="-Bru instant coffee is a high class, rich tasting coffee powder that offers you the best cup of morning coffee, not including taking much of your time. The sheer depth of flavor and smell will enjoyably surprise you."
	}
...
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/offers/bru-instant-coffee.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
    ...
    echo '<input type="hidden" name="product_code" value="bru" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 -Bru instant coffee is a high class, rich tasting coffee powder that offers you the best cup of morning coffee, not including taking much of your time. The sheer depth of flavor and smell will enjoyably surprise you.
	</td>
		</tr>
		</table>	</td>
    </tr>
...
<p style="width:50%">
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'bruinstantcoffee'; // required: replace example with your forum shortname
