...
$sql=mysql_query("select * from new_arrival where product_name='cucumber-hybrid-grade-a'");
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/new arrivals/cucumber-hybrid-grade-a.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
    ...
    echo '<input type="hidden" name="product_code" value="cuc" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		Cucumber Hybrid contains a striped light -dark green colored outer skin, which can be peeled or consumed with the peel. It is an extremely good source of Vitamin C, K and also includes vitamin A and B complex vitamins and minerals. It is low in calories and contains high water content.
