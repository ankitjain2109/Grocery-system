...
{
	document.getElementById("txtHint3").innerHTML="Butter, Coriander, Garlic, All purpose Flour
...
<form method="post" action="Bread_bakers dozen garlic.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/the-bakers-dozen-baguette-garlic.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Bakers Dozen- Garlic  </i>
	<br><i>275 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 100<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="The Bakers Dozen Baguette Garlic">
	<input type="hidden" name="product_price" value="100">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/the-bakers-dozen-baguette-garlic.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="garl" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>  Garlic</i>
		
		<br><br>
		<p><button value="Ingredients" type="button" border="1px" onClick="showUserabout()" style="background-color:#FFFFFF; width:80px; height:40px">Ingredients</button>
		...
		Butter, Coriander, Garlic, All purpose Flour
          No chemicals, No preservatives
		  	</td>
		</tr>
		</table>
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'breadbakersdozengarlic'; // required: replace example with your forum shortname
