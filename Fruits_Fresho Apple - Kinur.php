...
{
	document.getElementById("txtHint3").innerHTML="	 Kinur Apples are identified for their usual sweetness, colour, and succulence and prolonged shelf life. It is well known for high excellence and wide ranges apples. It is also packed of a fibre called pectin and fibre, a mixture that gives it a huge list of wellbeing benefits. It keeps against metabolic syndrome."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="It includes relief for indigestion, stomach disorders, anemia, weakness, dysentery, heart disease, rheumatism, eye disorders, cancer, gout, and skin care. It really helps you to lose fat and they have also provided high brain function."
	}
</script>
...
<form method="post" action="Fruits_Fresho Apple - Kinur.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/apple-fuji.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho Apple - Kinur</i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
  ...
  <tr><input type="hidden" name="product_name" value="Fresh Apple Kinur">
	<input type="hidden" name="product_price" value="40">
	<input type="hidden" name="product_imgname" value="Pj/fruits/apple-fuji.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="apple_kinur" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
			 Kinur Apples are identified for their usual sweetness, colour, and succulence and prolonged shelf life. It is well known for high excellence and wide ranges apples. It is also packed of a fibre called pectin and fibre, a mixture that gives it a huge list of wellbeing benefits. It keeps against metabolic syndrome.
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshoapplekinur'; // required: replace example with your forum shortname
