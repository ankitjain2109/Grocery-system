...
$sql=mysql_query("select * from new_arrival where product_name='brooke-bond-taj-mahal-tea-bags-honey-lemon-green'");
...
function showUserabout()
{
	...
	document.getElementById("txtHint3").innerHTML="Tajmahal brings to you its Honey Lemon Tea Bags which insures to be made up of 100 percent natural tea leaves. It has got fresh aroma, composed of natural ingredients and is also nutritious along with being delicious. Start your day with fresh and pure Tajmahal tea."
	}
...
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    ...
    <td height="275"><br>
      <img src="Pj/new arrivals/brooke-bond-taj-mahal-tea-bags-honey-lemon-green.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px"><br>	</td>
    <td valign="top">&nbsp;<br>
  ...
  <tr ><input type="hidden" name="product_name" value="<?php echo $res['product_name'];?>">
    ...
    echo '<input type="hidden" name="product_code" value="bnd" />';
	...
	Tajmahal brings to you its Honey Lemon Tea Bags which insures to be made up of 100 percent natural tea leaves. It has got fresh aroma, composed of natural ingredients and is also nutritious along with being delicious. Start your day with fresh and pure Tajmahal tea.
