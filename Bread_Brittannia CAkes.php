...
{
	document.getElementById("txtHint3").innerHTML=" Britannia Veg Cakes are the fruits of that philosophy. It completely made with eggless and pure, with the same taste of cake that the world has come to love. Every slice is 100% vegetarian and yet carries with it every aspect of cake."
	}
...
<form method="post" action="Bread_Brittannia CAkes.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/britannia-veg-cakes-twisty-fruity.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Brittania Fruit Cakes  </i>
	<br><i>75 gm Pouch</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 20<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Brittania Fruit Cakes">
	<input type="hidden" name="product_price" value="20">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/britannia-veg-cakes-twisty-fruity.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="fruitck" />';
  ...
  <tr >
    <td height="673" colspan="4">
	 ...
	 Britannia Veg Cakes are the fruits of that philosophy. It completely made with eggless and pure, with the same taste of cake that the world has come to love. Every slice is 100% vegetarian and yet carries with it every aspect of cake.
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
    <script type="text/javascript">
        ...
        var disqus_shortname = 'breadbrittanniacakes'; // required: replace example with your forum shortname
