...
function showUserabout()
	{
	document.getElementById("txtHint3").innerHTML="Glucon-D original is the preferred choice in summer when the scorching heat drains out body glucose. It contains 99.4% pure glucose. It is easily absorbed by body, thus giving instant energy & rejuvenation. It restores energy 2 times faster compared to ordinary drinks."
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="(Per 100 g) Calories 360 Sodium 0 mg Total Fat 0 g Potassium 0 mg Saturated 0 g Total Carbo 90 g Polyunsaturated 0 g Dietary Fiber 0 g Monounsaturated 0 g Sugars 0 g Trans 0 g Protein 0 g Cholesterol 0 mg Calcium 170%"
	}
...
<form method="post" action="Beverages_glucon-d original flavour.php">
...
<table width="226" height="572" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
  ...
  <tr>
    <td height="275"><br><img src="Pj/energy and drink/glucon-d-pure-glucose-original.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Glucon-D Pure Glucose - Original</i><br><i>500 gm</i> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 82<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Glucon-d Pure Glucose Original">
	<input type="hidden" name="product_price" value="82">
	<input type="hidden" name="product_imgname" value="Pj/energy and drink/glucon-d-pure-glucose-original.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="glcd" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Glucon-D Pure Glucose - Original</i>
		...
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Glucon-D original is the preferred choice in summer when the scorching heat drains out body glucose. It contains 99.4% pure glucose. It is easily absorbed by body, thus giving instant energy & rejuvenation. It restores energy 2 times faster compared to ordinary drinks.
...
<div id="disqus_thread" style="width:720px" align="center"></div>
    <script type="text/javascript">
        ...
        var disqus_shortname = 'glucondoriginalflavour'; // required: replace example with your forum shortname
