...
<div id="header" style="height:36px;width:100%; background-color:#ededed;" >
  ...
  <div id="slots"><a name="link23" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1004165716_0,0,19,null,'link23')" onMouseOut="MM_startTimeout();"><div class="shadow-radial" id="box1">Check our Delivery Slots</div></a></div>
...
<tr>
<th></th><th><img src="Pj/img5.jpg" align="middle" style="size:landscape; height: 70px; width:80px"/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="text" name="search" width="300px" height="200px" size="+60" placeholder="&nbsp;&nbsp;&nbsp;Search your needs" style="border-radius:8px; height:25px; width:500px";/></th>&nbsp;&nbsp;&nbsp;&nbsp;<th><input type="button" name="srchbutton" value="SEARCH" style="height:25px; width:80px"/></th>&nbsp;&nbsp;&nbsp;<th style="background-color:#f5f4f4"><span>Your Basket<?php echo " 0"; ?> Item<br> <img src="Pj/bskt.jpg" height="36px"/> </span></th>
</tr>
</table>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<table width="170px" height="800px" border="1" cellspacing="0" cellpadding="0"   style=" border:thin; border-color:#CCCCCC; float:left; margin-left:150px;" >
      <tr height="35px" bgcolor="#8fb242">
        <td height="35px" style="color:#FFFFFF;">&nbsp;&nbsp;&nbsp;&nbsp; SHOP<img src="Pj/img9.jpg" align="right"></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a name="link3" id="link4" style="font-size:11px;font-family:Arial, Helvetica, sans-serif;" onMouseOver="MM_showMenu(window.mm_menu_1004173024_0,150,0,null,'link3')" onMouseOut="MM_startTimeout();"><font class="text1">FRUITS & VEGETABLES</font><img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link15" id="link5" style="font-size:11px; font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005154101_0,150,0,null,'link15')" onMouseOut="MM_startTimeout();">GROCERY & STAPLES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link17" id="link7" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005155710_0,150,0,null,'link17')" onMouseOut="MM_startTimeout();">BREAD DIARY & EGGS<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link18" id="link9" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005160226_0,150,0,null,'link18')" onMouseOut="MM_startTimeout();">BEVERAGES<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
      ...
      <tr height="30px">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a class="text1"name="link6" id="link11" style="font-size:11px;font-family:Arial, Helvetica, sans-serif" onMouseOver="MM_showMenu(window.mm_menu_1005162054_0,150,-200,null,'link6')" onMouseOut="MM_startTimeout();">PERSONAL CARE<img src="Pj/arrows.gif" align="right" height="10" ></a></td>
      </tr>
      <tr height="30px">
	  ...
	  <b>Price</b><br><br>
	  <input type="radio" name="price[]" value="between21and50" onClick="showUser(this.value)" >Rs21 to Rs 50<br>
	  <input type="radio" name="price[]" value="between51and100" onClick="showUser(this.value)" >Rs51 to Rs 100<br>
	  <input type="radio" name="price[]" value="between101and200" onClick="showUser(this.value)" >Rs101 to Rs 200
	 ...
	 <input type="radio" name="pack_size[]" value="100gm" onClick="showUser(this.value)">100gm<br>
	  <input type="radio" name="pack_size[]" value="200gm" onClick="showUser(this.value)">200gm<br>
	  <input type="radio" name="pack_size[]" value="250gm" onClick="showUser(this.value)">250gm<br>
	  <input type="radio" name="pack_size[]" value="300gm" onClick="showUser(this.value)">300gm<br>
	  <input type="radio" name="pack_size[]" value="350gm" onClick="showUser(this.value)">350gm<br>
	  <input type="radio" name="pack_size[]" value="400gm" onClick="showUser(this.value)">400gm<br>
	  </tr>
	  <tr >
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a>NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; CUT VEGETABLES
	<select id="box2" style="background-color: #CCCCCC;" size="1" name="view_by" onChange="showUser(this.value)" >
