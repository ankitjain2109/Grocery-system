...
<form method="post" action="Fruits_Fresho Papaya.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    <td width="431" height="275"><br>
      <img src="Pj/fruits/papaya-local-medium-grade-a.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td width="357" valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>Fresho Papaya</i>
	<br><i>1 kg</i><br> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 44<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="Fresh Papaya">
	<input type="hidden" name="product_price" value="44">
	<input type="hidden" name="product_imgname" value="Pj/fruits/papaya-local-medium-grade-a.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="papaya" />';
  ...
  <tr >
    <td height="673" colspan="4">
	 ...
	 Papaya includes thin smooth skin dark green in color when undeveloped, which changes to orange or bright yellowish, as it ripens. It includes a delicious, succulent orange flesh sometimes with pink or yellow hues. Inside the internal cavity of the fruit are numerous black, round seeds covered in a gelatinous-like substance (some varieties are seedless). The enzymes which are liable for conducting most of the chemical reactions require for keeping good mental and physical health.
...
<script type="text/javascript">
        ...
        var disqus_shortname = 'fruitsfreshopapaya'; // required: replace example with your forum shortname
