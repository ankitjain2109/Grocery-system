...
{
	document.getElementById("txtHint3").innerHTML="One of the world's favourite French breads, some count my 25 layers, some talk about the flavour. Others try me with coffee and get lost in my sweetness!
         No chemicals, No preservatives; Contains egg"
	}
function showUseringredients()
	{
	document.getElementById("txtHint3").innerHTML="A healthy brown bread made using whole wheat (atta) and wheat bran. This bread is high in fibre and will make your sandwiches more tasty and healthy"
	}
</script>
...
<form method="post" action="Bread_bakers dozen burger buns.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr >
  <br>
    <td colspan="4">&nbsp; <font style="font-family:Arial, Helvetica, sans-serif">&nbsp;&nbsp;&nbsp;&nbsp; Bread Dairy & Eggs </font>	
  </tr>
  <tr>
  <tr >
  ...
  <tr>
    <td height="275"><br><img src="Pj/bread n bakery/the-bakers-dozen-burger-buns-whole-wheat.jpg" class="effectscale" width="240px" height="240px" style="margin-top:-30px; margin-left:30px">
	<br>
	</td>
    <td valign="top">&nbsp;<br>
	<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i>The Bakers Dozen: Burger Buns </i>
	<br><i>120 gm Pouch</i><br><i>65 gm Pouch</i> <?php ?>
	</b>
	<br>
	<br>
	<br><?php ?>
	<br>&nbsp;&nbsp;&nbsp;Rs 25<form action="cart_update.php" method="post">
  ...
  <tr><input type="hidden" name="product_name" value="The Bakers Dozen BurgerBuns Whole Wheat">
	<input type="hidden" name="product_price" value="25">
	<input type="hidden" name="product_imgname" value="Pj/bread n bakery/the-bakers-dozen-burger-buns-whole-wheat.jpg">
	<?php
	$current_url = base64_encode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    echo '<input type="hidden" name="product_code" value="brgbn" />';
  ...
  <tr >
    <td height="673" colspan="4">
		...
		<br>&nbsp;<b style="color:#000000; size:20px; vertical-align:top; font-size:35px"><i> Burger buns</i>
		...
		<!--<button value="Ingredients" border="1px" onClick="showUseringredients()" style="background-color:#FFFFFF; width:70px; height:40px">Ingredients</button>-->
		
		<table align="center" border="1px" height="22%" width="98%" vspace="30px">
		<tr>
		<td style="font-size:18px; border:thin;" id="txtHint3" class="image2">
		 Buns that will always match up to the filling
...
<p style="width:50%">
 <div id="disqus_thread" style="width:720px" align="center"></div>
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'breadbakersdozenburgerbuns'; // required: replace example with your forum shortname
