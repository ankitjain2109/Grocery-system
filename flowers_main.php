...
function showUser(str) {
  ...
  xmlhttp.open("GET","getflower.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<form method="post" action="flowers_main.php">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr bgcolor="#8FB242" style="height:50px;">
	...
	<a href="new_arrival.php" style="text-decoration:none;">NEW ARRIVALS</a><img src="Pj/img11.jpg" >	</td>
	 <td  style="text-align:left"> &nbsp;&nbsp;&nbsp; FLOWERS
	<select id="box2" style="background-color: #CCCCCC;  font-size:18px;" size="1" name="view_by" onChange="showUser(this.value)" >
